...
public class ReservaService {
    ...
    public ReservaEntity realizarReserva(String rutCliente, String nombreCliente, String correoCliente, LocalDate fechaReserva, LocalTime horaInicio,
    ...
    public boolean comprobarTopeHorario(LocalDate fecha, LocalTime horaInicio, LocalTime horaFin, int numIntegrantes){
        List<ReservaEntity> reservas = reservaRepositorio.findByFechaReserva(fecha);;
    ...
    public List<ReservaEntity> ObtenerReservas(){
        List<ReservaEntity> reservas = reservaRepositorio.findAll();
    ...
    public List<ReservaEntity> obtenerReservasEntreFechas(LocalDate fechaInicio, LocalDate fechaFin) {
    ...
    public PDDocument generarComprobanteReserva(ReservaEntity reserva) throws IOException {
    ...
    public void enviarComprobanteReserva(ReservaEntity reserva, String correoCliente) {
        try {
