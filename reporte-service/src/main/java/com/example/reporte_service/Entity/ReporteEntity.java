...
public class ReporteEntity {
    ...
    public ReporteEntity(String tipo, LocalDateTime fechaCreacion, LocalDate fechaInicio, LocalDate fechaFin, List<String> columnasMeses, List<String> filastipo, List<Double> vueltas1010, List<Double> vueltas1515, List<Double> vueltas2020, List<Double> totalesFilas) {
        this.tipo = tipo;
    ...
    public ReporteEntity(String tipo, LocalDateTime fechaCreacion, LocalDate fechaInicio, LocalDate fechaFin, List<String> columnasMeses, List<String> filastipo, List<Double> personas1a2, List<Double> personas3a5, List<Double> personas6a10, List<Double> personas11a15, List<Double> totalesFilas) {
        this.tipo = tipo;
        this.fechaCreacion = fechaCreacion;
        this.fechaInicio = fechaInicio;
        this.fechaFin = fechaFin;
