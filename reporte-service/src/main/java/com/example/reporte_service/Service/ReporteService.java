...
public class ReporteService {
    ...
    public ReporteEntity crearReporte(String tipo, LocalDate fechaInicio, LocalDate fechaFin) {
        ...
        if(!tipo.equals("Número de personas")) {
            ...
            ReporteEntity reporte = new ReporteEntity(tipo, fechaCreacion, fechaInicio, fechaFin, meses, filas, vueltas1010, vueltas1515, vueltas2020, totales);
        ...
        ReporteEntity reporte = new ReporteEntity(tipo, fechaCreacion, fechaInicio, fechaFin, meses, filas, personas1a2, personas3a5, personas6a10, personas11a15, totales);
        return reporteRepositorio.save(reporte);
    }
